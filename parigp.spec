...
polynomials, series, etc..., and not as expressions per se.  However it is
often much faster than other CAS,  and contains a large number of specific
functions not found elsewhere, essentially for use in number theory.

%description -l pl
System PARI / GP jest przeznaczony do wydajnych obliczeñ z zakresu teorii liczb, ale zawiera równie¿ inne przydatne funkcje. Jest nieco spokrewniony z Komputerowymi Systemami Algebraicznymi, ale nie identyczny, poniewa¿ traktuje wyra¿enia symboliczne jako obiekty matematyczne (macierze, wielomiany, szeregi itp.) a nie jako wyra¿enia same w sobie. Jest jednak czêsto znacznie szybszy od innych KSA-ów a ponadto zawiera wiele innych funkcji nie spotykanych gdzie indziej, a przydatnych zw³aszcza w teorii liczb.
...
Include files for shared PARI library. You need them to use PARI routines in you own programs.

%description -l pl -n pari-devel 
Pliki nag³ówkowe biblioteki wspó³dzielonej PARI. Bêdziesz ich potrzebowa³, je¿eli bêdziesz chcia³ wykorzystywaæ procedury PARI w swoich programach.
...
often much faster than other CAS,  and contains a large number of specific
functions not found elsewhere, essentially for use in number theory.
This package is statically linked with PARI library.

%description static -l pl
System PARI / GP jest przeznaczony do wydajnych obliczeñ z zakresu teorii liczb, ale zawiera równie¿ inne przydatne funkcje. Jest nieco spokrewniony z Komputerowymi Systemami Algebraicznymi, ale nie identyczny, poniewa¿ traktuje wyra¿enia symboliczne jako obiekty matematyczne (macierze, wielomiany, szeregi itp.) a nie
jako wyra¿enia same w sobie. Jest jednak czêsto znacznie szybszy od innych KSA-ów a ponadto zawiera wiele innych funkcji nie spotykanych gdzie indziej, a przydatnych zw³aszcza w teorii liczb.
Ten pakiet zosta³ zkonsolidowany statycznie z bibliotek± PARI.
