...
%description -l pl
System PARI/GP jest przeznaczony do wydajnych obliczeÒ z zakresu
teorii liczb, ale zawiera rÛwnieø inne przydatne funkcje. Jest nieco
spokrewniony z Komputerowymi Systemami Algebraicznymi, ale nie
identyczny, poniewaø traktuje wyraøenia symboliczne jako obiekty
matematyczne (macierze, wielomiany, szeregi itp.) a nie jako wyraøenia
same w sobie. Jest jednak czÍsto znacznie szybszy od innych KSA-Ûw a
...
Przyk≥adowe skrypty pisane w jÍzyku PARI/GP. Sam moøesz takie napisaÊ.
...
Konwerter skryptÛw PARI/GP do jÍzyka C. Moøna nim tworzyÊ w≥asne
programy w C korzystaj±ce z biblioteki pari. Znajomo∂Ê jÍzyka C nie
jest wymagana.
